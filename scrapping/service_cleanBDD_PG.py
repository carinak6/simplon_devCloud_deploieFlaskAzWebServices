...
class CleanBdd_PG:
    def __init__(self):
        ...
        try:
            ...
            print("Something went wrong, La connexion avec la base de données a échoué : {}".format(error))       
            self.echec =1
    ...
    def clean_bdd_etapeUn_href(self):
        ...
        try:
            ...
            #print('type de reponse ',type(res),' cuantos ==> ', len(res))#type de reponse  <class 'list'>  cuantos ==>  1
            liste_lien_effacer=[]
    ...
    def clear_annonces(self, liste_a):
        ...
        try:
            ...
            self.cnx.commit()
            print('number of rows deleted', len(liste_a))
            return True
